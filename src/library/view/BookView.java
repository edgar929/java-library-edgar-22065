...
import library.dao.BookcategoryDao;
...
public class BookView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tbook.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "title", "publisher", "Title 4", "Title 5"
            }
        ));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        b.setBookcategory(new Bookcategory(dao.getCategoryid(bcatcmb.getSelectedItem().toString())));
